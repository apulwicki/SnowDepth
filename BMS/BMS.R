...
rm(aspect, elevation, northness, profileCurve, slope, tangentCurve, Sx, centreD,params,swe,T)
...
####### G4 BMS ##########
  ...
  ##MCMC sampling
  att_mcmc = bms(G4, burn = 50000, iter = 1e+05, g = "BRIC", mprior = "uniform", nmodel = 2000, mcmc = "bd", user.int = F)
  plotConv(att_mcmc)
  summary(att_mcmc)
  coef(att_mcmc)
  plotModelsize(att_mcmc)
