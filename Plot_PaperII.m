...
%% Plot ->  Winter balance and RMSE
    %Accumulation subsets are dashed lines, no accumulation is solid lines
figure(1); clf
...
for g = 1:3;     glacier = options.glacier{g};
 ...
 for l = 1:Nhalf
    ...
    plot(n(:,l+Nhalf),Trmse.(glacier)(:,l+Nhalf),'Color',cols(l,:),'LineWidth',3); hold on
 end
 ...
 for l = 1:Nhalf
    ...
    plot(n(:,l+Nhalf),Tswe.(glacier)(:,l+Nhalf),'Color',cols(l,:),'LineWidth',3); hold on
 end
