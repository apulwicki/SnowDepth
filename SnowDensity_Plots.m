...
figure(2)
    x = nanmean(cell2mat(SWEtube_full(1:7,2:16)),2);
    y = cell2mat(SWEtube_full(1:7,22));
    error = nanstd(cell2mat(SWEtube_full(1:7,2:16)),1,2);
errorbarxy(x,y,error,[],{'ko', 'b', 'r'}); hold on

    x = nanmean(cell2mat(SWEtube_full(8:14,2:16)),2);
    y = cell2mat(SWEtube_full(8:14,22));
    error = nanstd(cell2mat(SWEtube_full(8:14,2:16)),1,2);
errorbarxy(x,y,error,[],{'ro', 'b', 'r'}); hold on

    x = nanmean(cell2mat(SWEtube_full(15:end,2:16)),2);
    y = cell2mat(SWEtube_full(15:end,22));
    error = nanstd(cell2mat(SWEtube_full(15:end,2:16)),1,2);
...
figure(3)
    x = cell2mat(Snowpit_full(1:4,2));
    y = cell2mat(Snowpit_full(1:4,5));
scatter(x,y,'Filled'); hold on
    x = cell2mat(Snowpit_full(5:7,2));
    y = cell2mat(Snowpit_full(5:7,5));
scatter(x,y,'Filled'); hold on    
    x = cell2mat(Snowpit_full(8:end,2));
    y = cell2mat(Snowpit_full(8:end,5));
scatter(x,y,'Filled')
